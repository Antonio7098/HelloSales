"""Unified PipelineContext for substrate architecture.

This module provides the canonical execution context for pipeline stages,
replacing the legacy PipelineContext from pipeline/context.py.
"""
...
from app.ai.substrate.events import EventSink, get_event_sink
from app.ai.substrate.stages.base import StageArtifact as Artifact
...
class PipelineContext:
    ...
    def set_stage_metadata(
        self, stage: str, metadata: dict[str, Any]
    ) -> None:
