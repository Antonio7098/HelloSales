...
from app.ai.substrate.events import DbPipelineEventSink, clear_event_sink, set_event_sink
        ...
        *,
        ...
        try:
            ...
            try:
                ...
                logger.exception("Failed to mark pipeline as canceled", extra={"pipeline_run_id": str(pipeline_run_id)})
            return {}
            ...
            try:
                ...
                logger.exception("Failed to mark pipeline as gracefully cancelled", extra={"pipeline_run_id": str(pipeline_run_id)})
            ...
            try:
                ...
                logger.exception("Failed to mark pipeline as failed", extra={"pipeline_run_id": str(pipeline_run_id)})
            raise
        finally:
                ...
                try:
                    ...
                    class MinimalContext:
                        def __init__(self):
                            ...
                            self.behavior = status_payload.get("behavior", "unknown") if status_payload else "unknown"
                            self.data = {}
