"""Unified stage types for substrate architecture.
...
class PipelineTimer:
    ...
    def started_at(self) -> datetime:
        ...
        return datetime.fromtimestamp(
            self._pipeline_start_ms / 1000.0,
            tz=UTC
        )
...
class StageOutput:
    ...
    def cancel(cls, reason: str = "", data: dict[str, Any] | None = None) -> StageOutput:
        ...
        return cls(
            ...
            data={"cancel_reason": reason, **(data or {})}
        )
...
class StageContext:
    ...
    def timer(self) -> PipelineTimer:
        ...
        if timer is None:
            ...
            object.__setattr__(timer, "_pipeline_start_ms", int(self._started_at.timestamp() * 1000))
        return timer
    ...
    def emit_event(self, type: str, data: dict[str, Any]) -> None:
        ...
        self._outputs.append(StageOutput(
            status=StageStatus.OK,
            events=[StageEvent(type=type, data=data)]
        ))
    ...
    def add_artifact(self, type: str, payload: dict[str, Any]) -> None:
        ...
        self._outputs.append(StageOutput(
            status=StageStatus.OK,
            artifacts=[StageArtifact(type=type, payload=payload)]
        ))
...
class Stage(Protocol):
    ...
    Every component in the substrate system is a Stage with a
