    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        result = {
            ...
            "memory": {
                ...
                "interaction_history_summary": self.memory.interaction_history_summary if self.memory else None,
            }
    ...
    def from_dict(cls, data: dict[str, Any]) -> ContextSnapshot:
        ...
        if data.get("profile"):
            ...
            profile = ProfileEnrichment(
                user_id=UUID(p["user_id"]) if p.get("user_id") else UUID("00000000-0000-0000-0000-000000000000"),
